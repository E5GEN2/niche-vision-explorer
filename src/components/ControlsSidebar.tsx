...
const ControlsSidebar: React.FC<ControlsSidebarProps> = ({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        fixed top-0 left-0 h-full w-80 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md border-r border-gray-200 dark:border-gray-700 shadow-2xl z-50
      ...
      `}>
        <div className="p-6 h-full overflow-y-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-700 dark:to-gray-800 rounded-2xl border border-gray-100 dark:border-gray-600 p-6 shadow-lg">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-5 text-lg flex items-center">
              ...
              <div className="space-y-3">
                <Button
                  ...
                  variant="outline"
                  className="w-full flex items-center justify-center space-x-2 h-12 rounded-xl border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 font-medium transition-all hover:scale-105"
                  disabled={isLoading}
                >
            ...
            {/* Status Card */}
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-600 dark:to-gray-700 rounded-2xl border border-gray-200 dark:border-gray-600 p-6 shadow-lg">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-4 text-lg flex items-center">
              ...
              <div className="text-sm">
                {isLoading ? (
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-700 dark:text-gray-300 font-medium">Ready</span>
                  </div>
                )}
              </div>
            </div>
